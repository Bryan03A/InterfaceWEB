...
const CATALOG_SERVICE_URL = process.env.CATALOG_SERVICE_URL || 'http://54.90.161.226/catalog';
// URL of the catalog-del-service microservice
const CATALOG_DEL_SERVICE_URL = process.env.CATALOG_DEL_SERVICE_URL || 'http://54.90.161.226/catalog-del';
// URL del microservicio de imágenes
const IMAGE_SERVICE_URL = process.env.IMAGE_SERVICE_URL || 'http://54.90.161.226/image';  // Cambia a la URL de tu servicio
