...
const CATALOG_SERVICE_URL = process.env.CATALOG_SERVICE_URL || 'http://3.224.44.87/catalog';
// URL of the catalog-del-service microservice
const CATALOG_DEL_SERVICE_URL = process.env.CATALOG_DEL_SERVICE_URL || 'http://3.224.44.87/catalog-del';
// URL del microservicio de imágenes
const IMAGE_SERVICE_URL = process.env.IMAGE_SERVICE_URL || 'http://3.224.44.87/image';  // Cambia a la URL de tu servicio
